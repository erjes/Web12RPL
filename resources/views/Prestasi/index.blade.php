    ...
    <div class="container"> 
        <div class="prestasi">
            <div class="prestasi-card">
              <h2 class="name">Achmad Rifqi</h2>
              <a class="popup-btn">View More</a>
              <img src="{{ asset('FotoSiswaPrestasi/ahmad.png') }}" class="prestasi-img" alt="">
            </div>
            <div class="popup-view">
              <div class="popup-card">
                <a><i class="fas fa-times close-btn"></i></a>
                <div class="prestasi-img">
                  <img src="{{ asset('FotoSiswaPrestasi/ahmad.png') }}" alt="">
                </div>
                <div class="info">
                  <h2>Achmad Rifqi</h2>
      ...
      <div class="prestasi">
        <div class="prestasi-card">
          <h2 class="name">Damar Juliansyah</h2>
          <a class="popup-btn">  View More  </a>
          <img src="{{ asset('FotoSiswaPrestasi/damar.png') }}" class="prestasi-img-1" alt="">
        </div>
        <div class="popup-view">
          <div class="popup-card">
            <a><i class="fas fa-times close-btn"></i></a>
            <div class="prestasi-img">
              <img src="{{ asset('FotoSiswaPrestasi/damar.png') }}" alt="">
            </div>
            <div class="info">
              <h2>Damar Juliansyah</h2>
              <p>Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo consequat.</p>
            </div>
          </div>
        </div>
      ...
      <div class="prestasi">
        <div class="prestasi-card">
          <h2 class="name">Dustin Junier Andi Monteri</h2>
          <a class="popup-btn">  View More  </a>
          <img src="{{ asset('FotoSiswaPrestasi/dustin.png') }}" class="prestasi-img-2" alt="">
        </div>
        <div class="popup-view">
          <div class="popup-card">
            <a><i class="fas fa-times close-btn"></i></a>
            <div class="prestasi-img">
              <img src="{{ asset('FotoSiswaPrestasi/dustin.png') }}" alt="">
            </div>
            <div class="info">
              <h2>Dustin Junier Andi Monteri</h2>
              <p>Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo consequat.</p>
            </div>
          </div>
        </div>
      ...
      <div class="prestasi">
        <div class="prestasi-card">
          <h2 class="name">Fattah Kalamukti</h2>
          <a class="popup-btn">  View More  </a>
          <img src="{{ asset('FotoSiswaPrestasi/fattah.png') }}" class="prestasi-img-2" alt="">
        </div>
        <div class="popup-view">
          <div class="popup-card">
            <a><i class="fas fa-times close-btn"></i></a>
            <div class="prestasi-img">
              <img src="{{ asset('FotoSiswaPrestasi/fattah.png') }}" alt="">
            </div>
            <div class="info">
              <h2>Fattah Kalamukti</h2>
              <p>Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo consequat.</p>
            </div>
          </div>
        </div>
      ...
      <div class="prestasi">
        <div class="prestasi-card">
          <h2 class="name">Febriyanti Gala</h2>
          <a class="popup-btn">  View More  </a>
          <img src="{{ asset('FotoSiswaPrestasi/eby.png') }}" class="prestasi-img-2" alt="">
        </div>
        <div class="popup-view">
          <div class="popup-card">
            <a><i class="fas fa-times close-btn"></i></a>
            <div class="prestasi-img">
              <img src="{{ asset('FotoSiswaPrestasi/eby.png') }}" alt="">
            </div>
            <div class="info">
              <h2>Febriyanti Gala</h2>
              <p>Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo consequat.</p>
            </div>
          </div>
        </div>
      ...
      <div class="prestasi">
        <div class="prestasi-card">
          <h2 class="name">Galuh Arya Maulana</h2>
          <a class="popup-btn">  View More  </a>
          <img src="{{ asset('FotoSiswaPrestasi/galuh.png') }}" class="prestasi-img-2" alt="">
        </div>
        <div class="popup-view">
          <div class="popup-card">
            <a><i class="fas fa-times close-btn"></i></a>
            <div class="prestasi-img">
              <img src="{{ asset('FotoSiswaPrestasi/galuh.png') }}" alt="">
            </div>
            <div class="info">
              <h2>Galuh Arya Maulana</h2>
              <p>Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo consequat.</p>
            </div>
          </div>
        </div>
      ...
      <div class="prestasi">
        <div class="prestasi-card">
          ...
          <a class="popup-btn">  View More  </a>
          <img src="{{ asset('FotoSiswaPrestasi/rizi.png') }}" class="prestasi-img-3" alt="">
        </div>
        <div class="popup-view">
          <div class="popup-card">
            <a><i class="fas fa-times close-btn"></i></a>
      ...
      <div class="prestasi">
        <div class="prestasi-card">
          <h2 class="name">Neti Amalia</h2>
          <a class="popup-btn">  View More  </a>
          <img src="{{ asset('FotoSiswaPrestasi/neti.png') }}" class="prestasi-img-3" alt="">
        </div>
        <div class="popup-view">
          <div class="popup-card">
            <a><i class="fas fa-times close-btn"></i></a>
            <div class="prestasi-img">
              <img src="{{ asset('FotoSiswaPrestasi/neti.png') }}" alt="">
            </div>
            <div class="info">
              <h2>Neti Amalia</h2>
              <p>Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo consequat.</p>
      ...
      <div class="prestasi">
        <div class="prestasi-card">
          <h2 class="name">Raisa Arifa Azahra</h2>
          <a class="popup-btn">  View More  </a>
          <img src="{{ asset('FotoSiswaPrestasi/raisa.png') }}" class="prestasi-img-3" alt="">
        </div>
        <div class="popup-view">
          <div class="popup-card">
            <a><i class="fas fa-times close-btn"></i></a>
            <div class="prestasi-img">
              <img src="{{ asset('FotoSiswaPrestasi/raisa.png') }}" alt="">
            </div>
            <div class="info">
              <h2>Raisa Arifa Azahra</h2>
              <p>Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo consequat.</p>
            </div>
          </div>
        </div>
      ...
      <div class="prestasi">
        <div class="prestasi-card">
          <h2 class="name">Willy Zaki</h2>
          <a class="popup-btn">  View More  </a>
          <img src="{{ asset('FotoSiswaPrestasi/willy.png') }}" class="prestasi-img-3" alt="">
        </div>
        <div class="popup-view">
          <div class="popup-card">
            <a><i class="fas fa-times close-btn"></i></a>
            <div class="prestasi-img">
              <img src="{{ asset('FotoSiswaPrestasi/willy.png') }}" alt="">
            </div>
            <div class="info">
              <h2>Willy Zaki</h2>
              <p>Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo consequat.</p>
      ...
      <div class="prestasi">
        <div class="prestasi-card">
          <h2 class="name">Yudhistira Raka Pratama</h2>
          <a class="popup-btn">  View More  </a>
          <img src="{{ asset('FotoSiswaPrestasi/yudhis.png') }}" class="prestasi-img-2" alt="">
        </div>
        <div class="popup-view">
          <div class="popup-card">
            <a><i class="fas fa-times close-btn"></i></a>
            <div class="prestasi-img">
              <img src="{{ asset('FotoSiswaPrestasi/yudhis.png') }}" alt="">
            </div>
            <div class="info">
              <h2>Yudhistira Raka Pratama</h2>
              <p>Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo consequat.</p>
            </div>
          </div>
        </div>
